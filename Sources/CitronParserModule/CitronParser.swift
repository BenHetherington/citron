...
public protocol CitronParser: AnyObject {
    ...
    @inlinable var yyNumberOfSymbols: Int { get } // YYNOCODE in lemon
    @inlinable var yyNumberOfStates: Int { get } // YYNSTATE in lemon

    // Action tables

    // The action (CitronParsingAction) is applicable only if
    // the look ahead symbol (CitronSymbolNumber) matches
    @inlinable var yyLookaheadAction: [(CitronSymbolNumber, CitronParsingAction)] { get } // yy_action + yy_lookahead in lemon

    @inlinable var yyShiftUseDefault: Int { get } // YY_SHIFT_USE_DFLT in lemon
    @inlinable var yyShiftOffsetMin: Int { get } // YY_SHIFT_MIN in lemon
    @inlinable var yyShiftOffsetMax: Int { get } // YY_SHIFT_MAX in lemon
    @inlinable var yyShiftOffset: [Int] { get } // yy_shift_ofst in lemon

    @inlinable var yyReduceUseDefault: Int { get } // YY_REDUCE_USE_DFLT in lemon
    @inlinable var yyReduceOffsetMin: Int { get } // YY_REDUCE_MIN in lemon
    @inlinable var yyReduceOffsetMax: Int { get } // YY_REDUCE_MAX in lemon
    @inlinable var yyReduceOffset: [Int] { get } // yy_reduce_ofst in lemon

    @inlinable var yyDefaultAction: [CitronParsingAction] { get } // yy_default in lemon

    // Fallback

    @inlinable var yyHasFallback: Bool { get } // YYFALLBACK in lemon
    @inlinable var yyFallback: [CitronSymbolNumber] { get } // yyFallback in lemon

    // Wildcard

    @inlinable var yyWildcard: CitronSymbolNumber? { get }

    // Rules

    @inlinable var yyRuleInfo: [(lhs: CitronSymbolNumber, nrhs: UInt)] { get }

    // Stack

    @inlinable var yyStack: [(stateOrRule: CitronStateOrRule, symbolCode: CitronSymbolNumber,
        symbol: CitronSymbol)] { get set }
    @inlinable var maxStackSize: Int? { get set }
    @inlinable var maxAttainedStackSize: Int { get set }

    // Tracing

    @inlinable var isTracingEnabled: Bool { get set }
    @inlinable var isTracingPrintsSymbolValues: Bool { get set }
    @inlinable var isTracingPrintsTokenValues: Bool { get set }
    @inlinable var yySymbolName: [String] { get } // yyTokenName in lemon
    @inlinable var yyRuleText: [String] { get } // yyRuleName in lemon

    // Functions that shall be defined in the autogenerated code

    @inlinable func yyTokenToSymbol(_ token: CitronToken) -> CitronSymbol
    @inlinable func yyInvokeCodeBlockForRule(ruleNumber: CitronRuleNumber) throws -> CitronSymbol
    @inlinable func yyUnwrapResultFromSymbol(_ symbol: CitronSymbol) -> CitronResult

    // Error capturing

    associatedtype CitronErrorCaptureDelegate

    @inlinable var errorCaptureDelegate: CitronErrorCaptureDelegate? { get set }

    @inlinable var yyErrorCaptureSymbolNumbersForState: [CitronStateNumber:[CitronSymbolNumber]] { get }
    @inlinable var yyCanErrorCapture: Bool { get }
    @inlinable var yyErrorCaptureDirectives: [CitronSymbolNumber:(endAfter:[[CitronTokenCode]],endBefore:[CitronTokenCode])] { get }
    @inlinable var yyErrorCaptureEndBeforeTokens: Set<CitronSymbolNumber> { get }
    @inlinable var yyErrorCaptureEndAfterSequenceEndingTokens: Set<CitronSymbolNumber> { get }

    @inlinable var yyStartSymbolNumber: CitronSymbolNumber { get }
    @inlinable var yyEndStateNumber: CitronStateNumber { get }

    @inlinable var yyErrorCaptureSavedError: (error: Error, isLexerError: Bool)? { get set }
    @inlinable var yyErrorCaptureTokensSinceError: [(token: CitronToken, tokenCode: CitronTokenCode)] { get set }
    @inlinable var yyErrorCaptureStackIndices: [Int] { get set }
    @inlinable var yyErrorCaptureStartSymbolStackIndex: Int? { get set }

    @inlinable var numberOfCapturedErrors: Int { get set }
...
public class _CitronParserUnexpectedTokenError<Token, TokenCode> : CitronParserError {
    ...
    @inlinable init(token: Token, tokenCode: TokenCode) {
        self.token = token
...
public struct _CitronErrorCaptureState<Token, TokenCode, SymbolCode> {
    ...
    @inlinable init(resolvedSymbols: [(symbolCode: SymbolCode, value: Any)], unclaimedTokens: [(token: Token, tokenCode: TokenCode)], nextToken: (token: Token, tokenCode: TokenCode)?) {
        self.resolvedSymbols = resolvedSymbols
        self.unclaimedTokens = unclaimedTokens
...
public extension CitronParser {
    @inlinable func consume(token: CitronToken, code tokenCode: CitronTokenCode) throws {
    ...
    @inlinable func endParsing() throws -> CitronResult {
...
internal extension CitronParser {
    @inlinable func throwOrSave(_ error: Error, isLexerError: Bool = false) throws {
    ...
    @inlinable func saveErrorForCapturingLater(error: Error, isLexerError: Bool) -> Bool {
    ...
    @inlinable func yyShouldAttemptErrorCapture() -> Bool {
        return (self.yyErrorCaptureSavedError != nil)
    }

    @inlinable func yyAttemptErrorCapture(nextToken: (token: CitronToken, tokenCode: CitronTokenCode)?, excludeSymbols: Set<CitronNonTerminalCode> = []) throws -> CitronErrorCaptureResult {
    ...
    @inlinable func stackUnwindInfoForErrorCapture(lookAhead: CitronTokenCode?, excludeSymbols: Set<CitronNonTerminalCode>)
...
internal extension CitronParser {
    ...
    @inlinable func yyPush(stateOrRule: CitronStateOrRule, symbolCode: CitronSymbolNumber, symbol: CitronSymbol) throws {
    ...
    @inlinable func yyPopAll() {
        while (!yyStack.isEmpty) {
            yyPop()
        }
    }

    @inlinable func yyPop(times n: Int) {
        for _ in 0 ..< n { yyPop() }
    }

    @inlinable func yyFindShiftAction(lookAhead la: CitronSymbolNumber) -> CitronParsingAction {
    ...
    @inlinable func yyFindReduceAction(state: CitronStateNumber, lookAhead: CitronSymbolNumber) -> CitronParsingAction {
    ...
    @inlinable func yyShift(state: CitronStateNumber, symbolCode: CitronSymbolNumber, token: CitronToken) throws {
    ...
    @inlinable func yyShiftReduce(rule: CitronRuleNumber, symbolCode: CitronSymbolNumber, token: CitronToken) throws {
        let symbol = yyTokenToSymbol(token)
    ...
    @inlinable func yyReduce(rule ruleNumber: CitronRuleNumber) throws -> CitronSymbol? {
    ...
    @inlinable func yyPerformReduceAction(symbol resultSymbol: CitronSymbol, code lhsSymbolCode: CitronSymbolNumber, isAccepted: inout Bool) throws {
...
internal extension CitronParser {
    @inlinable func tracePrint(_ msg: String) {
        if (isTracingEnabled) {
            print("\(msg)")
        }
    }

    @inlinable func tracePrint(_ msg: String, tokenCode: CitronTokenCode, token: CitronToken) {
        if (isTracingEnabled) {
    ...
    @inlinable func tracePrint(_ msg: String, symbolNumber: CitronSymbolNumber, symbol: CitronSymbol) {
        if (isTracingEnabled) {
    ...
    @inlinable func tracePrint(_ msg: String, _ closure: @autoclosure () -> String) {
        if (isTracingEnabled) {
            print("\(msg) \(closure())")
        }
    }

    @inlinable func tracePrint(_ msg: String, quoted closure: @autoclosure () -> String) {
        if (isTracingEnabled) {
            print("\(msg) \"\(closure())\"")
        }
    }

    @inlinable func symbolNameFor(code: CitronSymbolCode) -> String {
        return symbolNameFor(symbolNumber: code.rawValue)
    }

    @inlinable func symbolNameFor(code: CitronNonTerminalCode) -> String {
        return symbolNameFor(symbolNumber: code.rawValue)
    }

    @inlinable func symbolNameFor(symbolNumber i: CitronSymbolNumber) -> String {
        if (i > 0 && i < yySymbolName.count) { return yySymbolName[Int(i)] }
        return "?"
    }

    @inlinable func traceStack() {
        if (isTracingEnabled) {
...
internal extension Array {
    @inlinable subscript<I: BinaryInteger>(safe i: I) -> Element? {
        get {
            let index = Int(i)
...
internal extension Array where Element : Equatable {
    @inlinable func hasSuffix(_ suffix: Array<Element>) -> Bool {
